                              ...
                              @isset($brands)
                                  @forelse ($brands as $item)
                                    <tr class="">
                                      ...
                                      <td>
                                        @if ($item->status == 1)
                                          <a href="{{route('admin.setting.brand_status',['brand_id'=>$item->id])}}" class="label label-danger"> Disabled</a>
                                        @else
                                          <a href="{{route('admin.setting.brand_status',['brand_id'=>$item->id])}}" class="label label-success"> Enabled</a>
                                        @endif
                                        <a href="{{route('admin.setting.brand_form',['brand_id'=>$item->id])}}" class="label label-warning"> Edit</a>
                                      </td>
